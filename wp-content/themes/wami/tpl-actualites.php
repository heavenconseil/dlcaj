	 ...
	 <section id="workshop">        
        ...
        <div class="w_grid limited-content">
            <div class="grid-col col_size-12">
                <h1 class="title-button"><?php echo get_field("tpl_actu_titre") ? get_field("tpl_actu_titre") : "Les rendez-vous de la cour au jardin"; ?> <a href="<?php echo get_field("tpl_actu_lien_bouton_de_contact") ? get_field("tpl_actu_lien_bouton_de_contact") : wami_get_page_link('59'); ?>" class="button btn-secondary btn-to-right" <?php if(get_field("tpl_actu_bouton_contact_target_blank")) echo "target='_blank'"; ?>><?php echo get_field("tpl_actu_titre_texte_du_bouton_de_contact") ? get_field("tpl_actu_titre_texte_du_bouton_de_contact") : "nous contacter"; ?></a></h1>
            </div>            
