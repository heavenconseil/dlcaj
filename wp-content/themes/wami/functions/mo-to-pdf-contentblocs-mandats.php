    ...
    <div class="bloc">
        <div class="titre_3"><span><?php echo $number; ?> — <?php echo $titre; ?></span></div>
            ...
            <?php elseif($type_mandat == 'mandat_exigence') : ?>
                ...
                <p>A l'issue de cette première période, le mandat se reconduira exclusivement tacitement jusqu'à 24 mois,(Première période incluse) sauf dénonciation écrite pour une reconduction en Mandat simple.</p>
